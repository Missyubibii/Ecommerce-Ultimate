            ...
            <div>
                ...
                <div class="mt-2 flex items-center space-x-4">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm text-gray-600">Tổng: {{ $products->total() }}</span>
                    </div>
                    <div class="flex items-center">
        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div class="flex flex-wrap items-center gap-4">
                <div class="flex-1 min-w-[200px] relative">
                    ...
                    <input type="text" x-model="search" @keyup.enter="applyFilters()" placeholder="Tìm tên, SKU..."
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500">Không tìm thấy sản phẩm nào.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
