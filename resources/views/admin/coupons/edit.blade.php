            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-100">
                <div class="p-8">
                    <div class="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
                        <div>
                            <h1 class="text-3xl font-extrabold text-gray-900">Cập Nhật Mã Giảm Giá</h1>
                            <p class="mt-2 text-sm text-gray-500">Chỉnh sửa thông tin mã: <span class="text-indigo-600 font-mono">{{ $coupon->code }}</span></p>
                        </div>
                    ...
                    <form action="{{ route('admin.coupons.update', $coupon->id) }}" method="POST">
                        ...
                        <div class="space-y-10">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select name="channel" class="block w-full border-gray-200 rounded-xl shadow-sm focus:ring-indigo-500 focus:border-indigo-500 px-4 py-3">
                                            <option value="both" {{ old('channel', $coupon->channel) == 'both' ? 'selected' : '' }}>Tất cả (Hệ thống & Email)</option>
                                            <option value="system" {{ old('channel', $coupon->channel) == 'system' ? 'selected' : '' }}>Chỉ Hệ thống (Web)</option>
                                            <option value="email" {{ old('channel', $coupon->channel) == 'email' ? 'selected' : '' }}>Chỉ Email (Chào mừng/Tri ân)</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea name="description" rows="2"
                                            class="block w-full border-gray-200 rounded-xl shadow-sm focus:ring-indigo-500 focus:border-indigo-500 px-4 py-2">{{ old('description', $coupon->description) }}</textarea>
                                    </div>
                                </div>
                            </section>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-6 rounded-2xl">
                                    ...
                                    <div class="flex items-center mt-8">
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            ...
                                            <span class="ml-3 text-sm font-medium text-gray-700">Đang kích hoạt</span>
                                        </label>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section x-data="{ 
                                ...
                                searchBrand: '', 
                                searchProduct: '',
                                selectedCats: @js($coupon->applicable_categories ?? []),
                                selectedBrands: @js($coupon->applicable_brands ?? []),
                                selectedProducts: @js($coupon->applicable_products ?? []),
